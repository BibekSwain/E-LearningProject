        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    <img src="images/pythonfullstack.png" alt="Python fullstack">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=10"><button class="btn btn-preview">Buy</button></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Duration: 50 Days</p>
                        <p class="card-text"><span class="text-success">&#8377;2000</span> <del>&#8377;4000</del></p>
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=11"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=12"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
