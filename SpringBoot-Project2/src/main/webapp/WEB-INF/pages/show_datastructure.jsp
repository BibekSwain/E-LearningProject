        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    <img src="images/datastructure.png" alt="DataStructure">
                    <div class="card-body">
                        <h5 class="card-title">Data Structure</h5>
                        <p class="card-text">Duration: 3 Months</p>
                        <p class="card-text"><span class="text-success">&#8377;6000</span> <del>&#8377;7000</del></p>
                        <div class="d-flex justify-content-between">
                      <a href="buy?cno=14"><button class="btn btn-preview">Buy</button></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><span class="text-success">&#8377;3000</span> <del>&#8377;4000</del></p>
                        <div class="d-flex justify-content-between">
                     <a href="buy?cno=15"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
