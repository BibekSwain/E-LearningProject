   ...
   <div class="top-bar">
    ...
    <div class="content">
        <div class="row">
                ...
                <div class="course-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=1"><button class="btn btn-preview">Buy</button></a>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    <img src="images/advancejava.png" alt="Advanced Java">
                    <div class="card-body">
                        <h5 class="card-title">Advanced Java</h5>
                        <p class="card-text">Duration: 30 Days</p>
                        <p class="card-text"><span class="text-success">&#8377;5000</span> <del>&#8377;6000</del></p>
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=2"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Duration: 2 Months</p>
                        <p class="card-text"><span class="text-success">&#8377;6000</span> <del>&#8377;8000</del></p>
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=3"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                <div class="course-card">
                    <img src="images/microservice.png" alt="Spring Boot & Microservices">
                    <div class="card-body">
                        <h5 class="card-title">Spring Boot &amp; Microservices</h5>
                        <p class="card-text">Duration: 3 Months</p>
                        <p class="card-text"><span class="text-success">&#8377;6000</span> <del>&#8377;9000</del></p>
                        <div class="d-flex justify-content-between">
                            <a href="buy?cno=4"><button class="btn btn-preview">Buy</button></a>
                            <button class="btn btn-details">View Details</button>
                        </div>
                    </div>
                </div>
